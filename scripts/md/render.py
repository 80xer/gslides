...
def process_slides():
  with codecs.open(ROOT_DIR + '/presentation-output.html', 'w', encoding='utf8') as outfile:
    md = codecs.open(CUR_DIR + '/slides.md', encoding='utf8').read()
    md_slides = md.split('\n---\n')
    ...
    template = jinja2.Template(open(CUR_DIR + '/base.html').read())
